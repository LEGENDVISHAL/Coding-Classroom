...
class CheckFolder:
	...
	def run_test(self):
		...
		# 	array = replace(array, "output_file", os.path.join(compile_folder, file_name.split(".")[0] + ".out"))
		# 	return array
		...
		with multiprocessing.Pool(processes=10) as pool:
			results = pool.map(self.run_test_parallel, [file_name for file_name in files_to_be_checked])
